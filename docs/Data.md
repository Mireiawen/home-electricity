...
Software automation robot used to automate the fetching of data from websites.
...
## Installation
Clone this repository, it should include all required for fetching the data and configuring the services.
